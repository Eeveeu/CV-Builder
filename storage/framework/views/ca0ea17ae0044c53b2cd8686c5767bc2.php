...
<body>
    <div class="container">
        <div class="preview-wrapper">
            <?php if(!empty($cv['personal'])): ?>
                <div class="header-section">
                    <div class="name"><?php echo e($cv['personal']['name'] ?? 'Имя не указано'); ?></div>
                    <div class="contact-info">
                        <span>📧 <?php echo e($cv['personal']['email'] ?? 'email@example.com'); ?></span>
                        <span>📱 <?php echo e($cv['personal']['phone'] ?? '+7 (000) 000-00-00'); ?></span>
                        <span>📍 <?php echo e($cv['personal']['city'] ?? 'Город не указан'); ?></span>
                    </div>
                    <?php if(!empty($cv['summary'])): ?>
                        <div style="margin-top:12px;text-align:center;color:#cbd5e1;"><?php echo e($cv['summary']); ?></div>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
                    ...
                    <?php $__currentLoopData = $cv['experience']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="experience-item">
                            <div style="display: flex; justify-content: space-between; margin-bottom: 5px;">
                                <div>
                                    <div class="job-title"><?php echo e($exp['role'] ?? $exp['position'] ?? 'Должность не указана'); ?></div>
                                    <div class="company"><?php echo e($exp['company'] ?? 'Компания не указана'); ?></div>
                                </div>
                                <div class="period"><?php echo e($exp['period'] ?? 'Период не указан'); ?></div>
                            </div>
                ...
                <div class="section">
                    ...
                    <?php $__currentLoopData = $cv['education']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $edu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="education-item">
                            <div style="display: flex; justify-content: space-between; margin-bottom: 5px;">
                                <div>
                                    <div class="job-title"><?php echo e($edu['degree'] ?? $edu['specialization'] ?? 'Специальность не указана'); ?></div>
                                    <div class="company"><?php echo e($edu['school'] ?? $edu['institution'] ?? 'Учебное заведение не указано'); ?></div>
                                </div>
                                <div class="period"><?php echo e($edu['year'] ?? 'Год не указан'); ?></div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                        ...
                        <?php $__currentLoopData = $cv['skills']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="skill-badge">
                                <?php if(is_array($skill)): ?>
                                    <?php echo e($skill['name'] ?? $skill['title'] ?? 'Навык'); ?>
                ...
                <div class="section">
                    ...
                    <div>
                        <?php $__currentLoopData = (array) $cv['links']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ln): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div><a href="<?php echo e($ln); ?>" style="color:#c7d2fe"><?php echo e($ln); ?></a></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <div class="button-group">
                <a href="<?php echo e(route('cv.index')); ?>">← Вернуться к редактированию</a>
                <a href="<?php echo e(route('cv.download')); ?>">⬇️ Скачать CV</a>
...
<?php /**PATH C:\OSPanel\home\cv-builder\resources\views/cv/preview.blade.php ENDPATH**/ ?>